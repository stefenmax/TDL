% 该程序改编自Ron Rubinstein的程序包中的ksvddenoise.m，
% 去掉了字典训练和去噪部分，只用于生成参数params
% 
% 2013-12-10

function [params,verbose,msgdelta] = paraset(params,msgdelta)
...
% params.Edata = sqrt(prod(blocksize)) * sigma * gain * 5;   % target error for omp
